...
histData<-iris[,1]
histData<-as.data.frame(scale(histData))

ggplot()+
        geom_histogram(data=histData,aes(x=histData[,1],y=..density..),
                binwidth=0.3,
                colour="black", fill="white")+
        stat_density(data=histData,aes(x=histData[,1]),kernel="gaussian",alpha=0.8,adjust=0.3)+
        ggtitle("Kernel Density Estimate function on top of a histogram")
